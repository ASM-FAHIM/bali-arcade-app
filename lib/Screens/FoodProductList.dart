...
class FoodProductList extends StatefulWidget {
  FoodProductList({Key key}) : super(key: key);
  static String id = 'FoodProductList';
  @override
  _FoodProductListState createState() => _FoodProductListState();
}

class _FoodProductListState extends State<FoodProductList> {
  var isLoading = false;
  ...
  Future<bool> getFoodData() async {
    ...
    var fc = pref.getString('fcidList');
    setState(() {
      lan = p2;
    });
    String url = 'http://baliarcade.work/api/baliarcade/all/menu/$fc';
                                        ...
                                        children: [
                                          GestureDetector(
                                            onTap: () {
                                              ...
                                              res_id = filterdata[index]
                                                  ['restaurant_id'];
                                              print(res_id);
                                              //menuId
                                              men_id = filterdata[index]
                                                      ['menu_id']
                                                  .toString();

                                              print(men_id);

                                              diss = replaceBanglaNumber(di);
                                              discountss = double.parse(diss);
                                              print(discountss);
